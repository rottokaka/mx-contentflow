		...
		exports.fn.gotoLineDialog = function() {
			...
			if (editor.find("." + dialogName).length < 1)
			{
				var dialogContent = [
					...
					"<p style=\"margin: 0;\">" + dialogLang.label + " 1-" + lineCount +"&nbsp;&nbsp;&nbsp;<input contentType=\"number\" class=\"number-input\" style=\"width: 60px;\" value=\"1\" max=\"" + lineCount + "\" min=\"1\" data-line-number /></p>",
					"</div>"
				].join("\n");
