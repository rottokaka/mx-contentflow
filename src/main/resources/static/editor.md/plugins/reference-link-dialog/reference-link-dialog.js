		...
		exports.fn.referenceLinkDialog = function() {
            ...
            if (editor.find("." + dialogName).length < 1)
            {
                var dialogHTML = "<div class=\"" + classPrefix + "form\">" +
                                        ...
                                        "<input contentType=\"text\" value=\"[" + ReLinkId + "]\" data-name />" +
                                        "<br/>" +
                                        "<label>" + dialogLang.urlId + "</label>" +
                                        "<input contentType=\"text\" data-url-id />" +
                                        "<br/>" +
                                        "<label>" + dialogLang.url + "</label>" +
                                        "<input contentType=\"text\" value=\"http://\" data-url />" +
                                        "<br/>" +
                                        "<label>" + dialogLang.urlTitle + "</label>" +
                                        "<input contentType=\"text\" value=\"" + selection + "\" data-title />" +
                                        "<br/>" +
                                    "</div>";
