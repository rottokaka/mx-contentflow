...
- 支持通用 Markdown / CommonMark 和 GFM (GitHub Flavored Markdown) 风格的语法，也可[变身为代码编辑器](https://pandao.github.io/editor.md/examples/change-property.html)；
...
<script type="text/javascript">
    $(function() {
        var editor = editormd("editor", {
            ...
            path : "editor.md/lib/"  // Autoload modules property, codemirror, marked... dependents libs path
        });
    });
</script>
```
...
```javascript
{
    property                 : "gfm",          // gfm or markdown
    name                 : "",             // Form element name for post
    value                : "",             // value for CodeMirror, if property not gfm/markdown
    subject                : "",             // Editor.md self themes, before v1.5.0 is CodeMirror subject, default empty
    editorTheme          : "default",      // Editor area, this is CodeMirror subject at v1.5.0
    previewTheme         : "",             // Preview area subject, default empty
    ...
    readOnly             : false,          // Enable / disable readonly property
    tabSize              : 4,
    indentUnit           : 4,
    ...
    toolbarIcons         : "full",         // Toolbar icons property, options: full, simple, mini, See `editormd.toolbarModes` property.
    toolbarTitles        : {},
    toolbarHandlers      : {
        ucwords : function() {
