...
;(function(factory) {
    ...
    editormd.prototype    = editormd.fn = {
         ...
         *
         * @param   {String}     eventType      event contentType
    ...
    editormd.markedRenderer = function(markdownToC, options) {
        ...
        markedRenderer.listitem = function(text) {
            ...
            {
                text = text.replace(/^\s*\[\s\]\s*/, "<input contentType=\"checkbox\" class=\"task-list-item-checkbox\" /> ")
                           .replace(/^\s*\[x\]\s*/,  "<input contentType=\"checkbox\" class=\"task-list-item-checkbox\" checked disabled /> ");
    ...
    /**
     * 鼠标和触摸事件的判断/选择方法
     * MouseEvent or TouchEvent contentType switch
     *
