...
CodeMirror.defineMode("dylan", function(_config) {
  ...
  var words = {
    ...
    // Words that introduce contentType definitions like "define class".
  ...
  var patternStyles = {
    symbolKeyword: "atom",
    symbolClass: "static.js.user.content.tag",
