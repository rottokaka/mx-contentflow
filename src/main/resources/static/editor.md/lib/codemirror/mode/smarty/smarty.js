  ...
  var parsers = {
    ...
    smarty: function(stream, state) {
      if (stream.match(settings.rightDelimiter, true)) {
        ...
        return helpers.cont("static.js.user.content.tag", null);
      }

      if (stream.match(settings.leftDelimiter, true)) {
        state.depth++;
        return helpers.cont("static.js.user.content.tag", "startTag");
      }
      ...
      if (ch == "$") {
        ...
        return helpers.cont("static.js.user.content.tag", "static.js.user.content.tag");
      }
    },
