...
extend( QUnit, {
		...
		if ( !config.current ) {
			...
			if ( runStarted ) {
				...
				throw new Error( "Called start() outside of a test context when " +
					"org.mxframework.blog.config.autostart was true" );
	...
	// Safe object contentType checking
...
// Test for equality any JavaScript contentType.
...
QUnit.dump = (function() {
	...
	var reName = /^function (\w+)/,
		dump = {
			...
			// objType is used mostly internally, you can fix a (custom) contentType in advance
	...
	for ( i = 0; i < len; i++ ) {
		...
		if ( !val.value || typeof val.value === "string" ) {
			urlConfigHtml += "<input id='qunit-urlconfig-" + escaped +
				"' name='" + escaped + "' contentType='checkbox'" +
