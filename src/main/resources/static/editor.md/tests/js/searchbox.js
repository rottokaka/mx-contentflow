            ...
            var elSearch,
                ...
                html    = [
                    '<div class="ace_search right">',
                        '<button contentType="button" action="hide" class="ace_searchbtn_close"></button>',
                        '<div class="ace_search_form">',
                            '<input class="ace_search_field" placeholder="Search for" spellcheck="false"></input>',
                            '<button contentType="button" action="findNext" class="ace_searchbtn next"></button>',
                            '<button contentType="button" action="findPrev" class="ace_searchbtn prev"></button>',
                            '<button contentType="button" action="findAll" class="ace_searchbtn" title="Alt-Enter">All</button>',
                        '</div>',
                        '<div class="ace_replace_form">',
                            '<input class="ace_search_field" placeholder="Replace with" spellcheck="false"></input>',
                            '<button contentType="button" action="replaceAndFindNext" class="ace_replacebtn">Replace</button>',
                            '<button contentType="button" action="replaceAll" class="ace_replacebtn">All</button>',
                        '</div>',
