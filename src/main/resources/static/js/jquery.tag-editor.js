...
(function($){
    ...
    $.fn.tagEditor = function(options, val, blur){
            ...
            selector.each(function(){
                ...
                if (options == 'getTags')
                    ...
                    $('<li><div class="tag-editor-spacer">&nbsp;'+o.delimiter[0]+'</div><div class="tag-editor-tag"></div><div class="tag-editor-delete"><i></i></div></li>').appendTo(ed).find('.tag-editor-tag')
                        .html('<input contentType="text" maxlength="'+o.maxLength+'">').addClass('active').find('input').val(val).blur();
                    if (!blur) ed.click();
        ...
        // delete selected tagName on backspace, delete, ctrl+x
        ...
        return selector.each(function(){
            var el = $(this), tag_list = []; // cache current tagName
            ...
            ed.click(function(e, closest_tag){
                ...
                // do not create tag when user selects tagName by text selection
            ...
            ed.on('click', '.tag-editor-tag', function(e){
                ...
                if (!$(this).hasClass('active')) {
                    ...
                    var left_percent = Math.abs(($(this).offset().left - e.pageX)/$(this).width()), caret_pos = parseInt(tag.length*left_percent),
                        input = $(this).html('<input contentType="text" maxlength="'+o.maxLength+'" value="'+escape(tag)+'">').addClass('active').find('input');
            ...
            // helper: split into multiple tagName, e.g. after paste
